(function(){
  ...
  function editNews(i=null){
    ...
    openModal(i===null?'Aggiungi news':'Modifica news',`<div class="fields">
      ...
      <div class="field full"><div style="border:2px solid #ffd400;border-radius:14px;padding:16px">
        <label style="display:flex;align-items:center;gap:10px;cursor:pointer;font-weight:900"><input id="cnNotify" type="checkbox" style="width:22px;height:22px;accent-color:#ffd400"> 🔔 Invia una notifica dopo il salvataggio</label>
        <div style="display:flex;gap:14px;flex-wrap:wrap;margin-top:14px">
          <label style="display:flex;align-items:center;gap:8px;cursor:pointer;font-weight:800"><input id="cnNotifyApp" type="checkbox" checked style="width:18px;height:18px;accent-color:#ffd400"> 📱 App</label>
          <label style="display:flex;align-items:center;gap:8px;cursor:pointer;font-weight:800"><input id="cnNotifyWeb" type="checkbox" checked style="width:18px;height:18px;accent-color:#ffd400"> 🌐 Sito</label>
        </div>
